...
# Loas (downloaded if needed) the MNIST dataset
...
# One hidden layer with same neurons as input (i.e. 784)
def baseline_model():
    #create model
    model = Sequential()
    model.add(Dense(num_pixel, kernel_initializer='normal', activation='relu'))
