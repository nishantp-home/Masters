...
for i in range(num_generation):
    ...
    for parent in current_generation:
        # each parent will have b/w 1 and 3 children
    ...
    print("Finished creating generation %d / %d, size= %d" % (i+2, num_generation + 1, len(current_generation)))
...
# which doesnot return a symmetric matric
...
dist_array = ssd.squareform(dist_matrix)   # convert a symmetric matrix 
                                           # with zero-valued diagonal into a vector
